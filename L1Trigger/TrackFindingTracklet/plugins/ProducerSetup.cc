...
namespace trklet {
  ...
  ProducerSetup::ProducerSetup(const edm::ParameterSet& iConfig) {
    ...
    config_.tmWidthInv2R = pSetTM.getParameter<int>("WidthInv2R");
    config_.tmWidthPhiT = pSetTM.getParameter<int>("WidthPhiT");
    config_.tmWidthZT = pSetTM.getParameter<int>("WidthZT");
