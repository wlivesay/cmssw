...
namespace hph {
  ...
  private:
    ...
    edm::ESGetToken<trklet::LayerEncoding, trackerDTC::SetupRcd> esGetTokenLayerEncoding_;
  };
  ...
  std::unique_ptr<Setup> ProducerHPH::produce(const trackerDTC::SetupRcd& Rcd) {
    ...
    const trklet::LayerEncoding& layerEncoding = Rcd.get(esGetTokenLayerEncoding_);
