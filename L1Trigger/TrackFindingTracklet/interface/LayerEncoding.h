#ifndef L1Trigger_TrackFindingTracklet_LayerEncoding_h
#define L1Trigger_TrackFindingTracklet_LayerEncoding_h
...
EVENTSETUP_DATA_DEFAULT_RECORD(trklet::LayerEncoding, trackerDTC::SetupRcd);
