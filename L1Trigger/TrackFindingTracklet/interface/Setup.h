...
namespace trklet {
  ...
  public:
    ...
    struct Config {
      ...
      // number of Bits used to represent inv2R
      int tmWidthInv2R;
      // number of Bits used to represent phiT
      int tmWidthPhiT;
      // number of Bits used to represent zT
      int tmWidthZT;
    ...
    //recalculates track parameter and stub residuals from DTC stubs
    bool tmUseDTCStubs() const { return config_.tmUseDTCStubs; }
    //recalculates track parameter and stub residuals from DTC stubs
    bool tmUseTTStubs() const { return config_.tmUseTTStubs; }
    // number of Bits used to represent inv2R
    int tmWidthInv2R() const { return config_.tmWidthInv2R; }
    // number of Bits used to represent phiT
    int tmWidthPhiT() const { return config_.tmWidthPhiT; }
    // number of Bits used to represent zT
    int tmWidthZT() const { return config_.tmWidthZT; }
    // number of Bits used to represent stub phi uncertainty in rad
    int tmWidthDPhi() const { return config_.tmWidthDPhi; }
    // number of Bits used to represent stub z uncertainty in cm
    int tmWidthDZ() const { return config_.tmWidthDZ; }
